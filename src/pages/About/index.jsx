...
const cultures = [
  { icon: <CiMedal />, title: '我们的使命', content: ['助力企业商旅数智升级，降本增效'] },
  { icon: <HiOutlinePaperAirplane />, title: '我们的愿景', content: ['成为中国商旅行业第一品牌'] },
  { icon: <GrDiamond />, title: '我们的价值观', content: ['追求致优，砥砺创新'] },
]
...
const features = ['优创商旅员工休闲区', '优创商旅办公区域', '优创商旅会议室']
      ...
      <div className="introduction">
        ...
        <div className="wrapper">
          ...
          <div className='text'>
            ...
            <p>我们的资质: 国家旅游局出境和国内旅游资质, 上海市会议经营与达标机构, 国际航协IATA资质, 公务员机票政府采购资质</p>
      ...
      <div className="qualification">
        ...
        <div className="items">
          {qualifications.map((qualification, i) => (
            <div className="wrapper" key={qualification.join('')}>
              <div className="card">
