...
const resources = [
  ...
  { icon: <BiCheckShield />, title: '品质保障', content: ['上海市4A级旅行社', '15年行业经验'] },
...
const advantages = [
  ...
  { icon: <CiMedal />, title: '专业可靠', content: ['全国百强旅行社', '上海市4A级旅行社', '15年行业经验'] },
...
const cases = [
  { title: '上海某知名医疗器械公司', contents: ['游玩路线: 三亚4日定制游', '出游人数: 100人', '出发日期: 2019年10月'] },
  { title: '苏州某知名新材料公司', contents: ['游玩路线: 桂林5日定制游', '出游人数: 130人', '出发日期: 2021年5月'] },
  { title: '上海某知名国际学校', contents: ['游玩路线: 大理6日定制', '出游人数: 200人', '出发日期: 2020年12月'] },
  { title: '上海某知名风能公司', contents: ['游玩路线: 崇明2日', '出游人数: 350人', '出发日期: 2020年11月'] },
]
