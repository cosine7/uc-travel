...
const businesses = [
  ...
  { icon: <FaPassport />, title: '签证', content: ['提供展览活动、团建年会、奖励旅游等各类会务的策划与执行服务', '专业策划师协助企业定制、策划与实施国内外奖励旅游、商务考察出行计划', '全程实施严格的标准化流程管理控制', '依托大旅游生态产业链, 提供优质整合服务, 专业合规保护及风险管控'] },
  ...
  return (
    <div className='solution'>
      <Banner
        ...
        subtitle='solution'
        content={[
          '一切差旅管理工作都可以从优创商旅开始。无论是行程制定、账单管理、企业授信,',
          '团队成员以更高效的协作方式，为运营管理目标不断创造成果。',
        ]}
      />
      <div className="business">
        <h1>商旅产品解决方案</h1>
        <h4>为企业用户提供机票、酒店、火车、签证、保险、旅游等一站式差旅服务</h4>
        <div className='items'>
      ...
      <div className="system">
        <h1>UCT商旅系统</h1>
        <h4>优创商旅自主研发UTC商旅系统, 对接主流费控系统, 宗旨 "帮企业客户, 控差旅标准, 省差旅费用", 可省30%差旅费用</h4>
        <div className='items'>
          {systems.map(system => (
      ...
      <div className="travel">
        <div className="mask">
          <h1>费控系统解决方案</h1>
          <h4>通过显性成本 (机票、酒店、高铁等大客户协议低价) + 隐性成本 (审批、合规、差标等) 双重精细化管控, 有效提高商旅效率近60%, 节省差旅成本近30%</h4>
          <div className="items">
            {travels.map(travel => (
      ...
      <div className="connection">
        <h1>商旅系统对接方案</h1>
        <h4>致力将UCT商旅系统打造为场景化、定制化、人性化为特征的智能商旅系统</h4>
        <h3>对接方式</h3>
